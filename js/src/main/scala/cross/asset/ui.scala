...
object ui { //6
  ...
  val `asset-island-front-1` = Asset("/image/asset-island-front-1.png")
  val `asset-island-front-2` = Asset("/image/asset-island-front-2.png")
  val `asset-island-front-3` = Asset("/image/asset-island-front-3.png")
  val `asset-island-front-4` = Asset("/image/asset-island-front-4.png")
  val `asset-island-front-5` = Asset("/image/asset-island-front-5.png")
...
val all = List(`asset-island-back`, `asset-island-front-1`, `asset-island-front-2`, `asset-island-front-3`, `asset-island-front-4`, `asset-island-front-5`, `asset-loading-disabled`, `asset-loading-normal`, `asset-progress-empty`, `asset-progress-full`, `asset-progress-shine`, `asset-sky`, `asset-start-hover`, `asset-start-normal`, `asset-start-pressed`, `asset-tree-hover`, `asset-tree-normal`, `asset-tree-pressed`) //8
} //9
